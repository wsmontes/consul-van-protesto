...
test('home exposes favicon and direct raster social sharing metadata for production domain', async () => {
  ...
  assert.match(html, /name=["']twitter:image["'][^>]+https:\/\/acjgeiavokkgodhhamak\.supabase\.co\/functions\/v1\/site-assets\/og\.png/i);
});
